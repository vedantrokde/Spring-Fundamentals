...
public class LoggingAspect {
    ...
    @AfterThrowing(
        pointcut = "execution(* com.springAop.afterThrowing.dao.AccountDao.findAccounts(..))",
        throwing = "exc"
    )
    ...
    @AfterReturning(pointcut = "execution(* com.springAop.afterThrowing.dao.AccountDao.findAccounts(..))", returning = "result")
